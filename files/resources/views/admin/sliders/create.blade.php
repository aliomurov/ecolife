                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            {!! Form::label('name', 'Название слайдера') !!}
                            {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Название слайдера']) !!}
                            @if($errors->has('name'))
                                <span class="text-danger">Это поле обьязательно!</span>
                            @endif
                        </div>
                        <div class="form-group">
                            {!! Form::label('description', 'Введите описание для слайдера') !!}
                            {!! Form::textarea('description', null, ['class' => 'form-control', 'placeholder' => 'Введите описание для слайдера']) !!}
