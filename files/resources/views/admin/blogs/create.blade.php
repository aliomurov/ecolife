        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        {!! Form::open(['route' => 'blog.store', 'method' => 'put', 'files' => true]) !!}
                        ...
                        <div class="form-group">
                            {!! Form::label('description', 'Введите текст') !!}
                            {!! Form::textarea('description', null, ['class' => 'form-control', 'placeholder' => 'Введите текст']) !!}
