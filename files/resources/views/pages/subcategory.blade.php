    ...
    <div class="container">
        ...
        <div class="row cart-title-eco">
            <div class="title-product">
                @if(request()->brand)
                    <h5 class="display-4">{{$subcategory->name}} / Брэнд - {{$productName}}</h5>
                @else
        ...
        <div class="row">
            <div class="col-sm-3">
                ...
                @endforeach
                @include('include.brand-subcategory')
            </div>
            <div class="col-sm-9">
                <div class="product-grid-block">
                    ...
                    <div class="block-product">
                        <div class="block-product-grid">
                            @foreach($subcategory_products as $catproduct)
                                                                    ...
                                                                    <div class="col-sm-7 text-left">
                                                                        <table class="table">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <a href="{{route('pages.brand', $catproduct->brand->slug)}}">
                ...
                {{ $subcategory_products->appends(request()->input())->links() }}
            </div>
        </div>
    </div>
@endsection
